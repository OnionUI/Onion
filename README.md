...
It's an option, however we consider the launcher to be central to the Onion OS experience.   
It is essentially an user interface designed to be triggered when the miyoo mini starts.  
