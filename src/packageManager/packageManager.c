...
{    
	...
	surfaceBackground = IMG_Load("./ressources/bgApp.png");
	surfaceSelection = IMG_Load("./ressources/selection.png");
	surfaceTableau = IMG_Load("./ressources/tableau.png");
	surfacesTabSelection = IMG_Load("./ressources/selectionTitle.png");
	surfaceScroller = IMG_Load("./ressources/scroller.png");
	surfaceCheck = IMG_Load("./ressources/checked.png");
	surfaceCross = IMG_Load("./ressources/cross.png");
