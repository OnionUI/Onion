...
void settings_load(void)
{
    ...
    json_getNumberValue(json_root, "vol", &settings.volume);
    json_getStringValue(json_root, "keymap", settings.keymap);
    json_getNumberValue(json_root, "mute", &settings.mute);
    json_getNumberValue(json_root, "bgmvol", &settings.bgm_volume);
    json_getNumberValue(json_root, "brightness", &settings.brightness);
    json_getStringValue(json_root, "language", settings.language);
    json_getNumberValue(json_root, "hibernate", &settings.sleep_timer);
    json_getNumberValue(json_root, "lumination", &settings.lumination);
    json_getNumberValue(json_root, "hue", &settings.hue);
    json_getNumberValue(json_root, "saturation", &settings.saturation);
    json_getNumberValue(json_root, "contrast", &settings.contrast);
    json_getStringValue(json_root, "theme", settings.theme);
    json_getNumberValue(json_root, "fontsize", &settings.fontsize);
    json_getNumberValue(json_root, "audiofix", &settings.audiofix);
