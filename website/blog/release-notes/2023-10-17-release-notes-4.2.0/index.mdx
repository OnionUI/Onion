...
Many new settings in Tweaks for the Miyoo Mini Plus : time sync settings, network settings, LCD voltage...

</Card>

## Network features (Miyoo Mini Plus-only)
...
A compilation of bftpd to provide a great FTP experience to transfer content to and from your Miyoo Mini Plus.
...
Adds dropbear SSH support to the Miyoo Mini Plus, utilisating new authentication methods.
...
Samba makes it easy to access and manage your stored content on your Miyoo Mini Plus across various types of devices and operating systems.
...
* Fixed the "About Device" screen displaying the wrong model number on the Miyoo Mini - *by @tGecko*
