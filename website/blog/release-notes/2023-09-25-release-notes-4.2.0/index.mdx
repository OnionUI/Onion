...
*Click the theme title to download.*


### New original themes

<ThemeCollection>
  <ThemeCard theme="Fake Pocket by Oclain" />
  <ThemeCard theme="Valorant by Skimpertushi" />
  <ThemeCard theme="Neumorphism (3-pack) by bantam" />
  <ThemeCard theme="NBA Onion by Tom Tower" />
  <ThemeCard theme="2CleanMini by Sheezie" />
  <ThemeCard theme="ONION Simpson by Polpetta" />
  <ThemeCard theme="Ultralight by parkinglotmusic" />
  <ThemeCard theme="Nokiyoo by UnBurn" />
  <ThemeCard theme="RetroRama by TooGeekCreations" />
  <ThemeCard theme="Blank Space Inverted by ElectRefurbish" />
  <ThemeCard theme="Wasteland by Bernig" />
  <ThemeCard theme="Blank Space by ElectRefurbish" />
  <ThemeCard theme="999-in-1 by UnBurn" />
  <ThemeCard theme="Zelda Oracle by Slak211" />
  <ThemeCard theme="Beneath The Mask by UnBurn" />
  <ThemeCard theme="Pocket Gank by UnBurn" />
  <ThemeCard theme="Spider-Miyoo by ElectRefurbish" />
  <ThemeCard theme="Notebook Kawaii by UnBurn" />
  <ThemeCard theme="Dragon Ball Mini by UnBurn" />
  <ThemeCard theme="Lylat System by UnBurn" />
  <ThemeCard theme="sharp by m_axic" />
  <ThemeCard theme="Original by SandsByte" />
  <ThemeCard theme="A Link to the Past by tendo209" />
  <ThemeCard theme="OOSFC by ytdcpndsgn" />
  <ThemeCard theme="TOTK by NaraMakesGames" />
  <ThemeCard theme="klar (8-pack) by m_axic" />
  <ThemeCard theme="MegaManX by NoLetterhead485" />
</ThemeCollection>
...
<ThemeCollection>
  <ThemeCard theme="Super Onion Entertainment System Remix by TheDewd + Quack Walks" />
  <ThemeCard theme="NanoSwitch Modern Dark by Amdy + Cheetashock" />
  <ThemeCard theme="Milk Black by Segich + Nemi" />
  <ThemeCard theme="Blueprint Variations by Aemiii91 + r3b0rn" />
  <ThemeCard theme="Blueprint Ghosts by Aemiii91 + ax2far" />
</ThemeCollection>
