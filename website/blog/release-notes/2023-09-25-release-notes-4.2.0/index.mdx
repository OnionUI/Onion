...
A framework to allow scripts to be delivered to users and added to, and executed from Tweaks. 
...
The Onion network services you know and love have been moved! They now live in Tweaks!
...
Adds dropbear SSH support to the MMP, utilisating authentication methods provided by @tGecko - also enables SFTP functionality when SSH is enabled.
...
This currently adds support for Pokémon trading on 1st gen Pokémon games through TGBDual (and may support games with similar save requirements)
