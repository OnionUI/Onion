...
- Edit your `wpa_supplicant.conf` file (found in `/appconfigs/wpa_supplicant.conf`)
- Use third-party apps such as: [this one](https://github.com/XK9274/better-wifi-miyoo), which supports most special characters
- Use Onions built in WPS function (if your router supports pinless WPS). You can find this in **Tweaks** › **Network** › **WPS**.
