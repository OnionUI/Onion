...
START + L2 / R2 Adjust volume boost ([see shortcuts](/docs/shortcuts))
...
- it avoid the risk of bad flash.
- the original firmware of the Miyoo Mini starts up really fast !
After the boot the first binary launched by the firmware is the Onion scripts directly from the SD card, making the boot of Onion OS fast and safe.
