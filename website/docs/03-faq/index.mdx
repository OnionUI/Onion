...
Onion has a built-in scraper (Miyoo Mini Plus only):
...
5. Eject your SD card from your computer and plug it into the Miyoo Mini, then open up your favorite game (for which you have downloaded cheats),
...
> Notes:
> Systems in OnionOS are displayed in alphabetical order, so the name will determine where in your list it sits.   
...
The blue LED on the Miyoo Mini Plus is unfortunately non-functional, the red LED will turn off when fully charged.

**Miyoo Mini v2:** Miyoo recommends 5V 1A and it must be USB-A to USB-C _(USB-C to USB-C charging is not supported)_.
**Miyoo Mini Plus and Miyoo Mini v4:** Supports USB-C to USB-C charging (the support is limited, and some chargers will not be accepted / start charging)
...
After the boot, the first binary launched from the SD card by the firmware is the Onion scripts directly, making the boot of OnionOS fast and safe.
