...
<IconLink href="https://drive.google.com/drive/folders/1VtfcBCoIcpMIBY2FIyAtjV-Dg02JUvhG" icon="cloud_download">Firmware 20220409</IconLink> (recommended version)<br/>
...
3. You need at least firmware version `20230505****`, if you have an older version please download the recommended firmware linked below.
   ...
   - `2023 03 29 2051` ⚠️
   - `2023 05 05 2130` ✔️
   - `2023 06 09 2122` ✔️ (recommended)
   - `2023 06 28 2128` ✔️

:::note Firmware downloads (MMP)

<IconLink href="https://app.sugarsync.com/iris/wf/D4978471_09235444_029620" icon="cloud_download">Firmware 20230609</IconLink> (recommended version)
