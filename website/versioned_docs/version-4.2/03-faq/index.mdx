...
**Miyoo Mini:** Miyoo recommends 5V 1A and it must be USB-A to USB-C _(USB-C to USB-C charging is not supported)_.  
**Miyoo Mini Plus:** Supports USB-C to USB-C charging (the support is limited, and some chargers will not be accepted/start charging).
