...
Menu_Config()
{
    ...
    Option2="Modify your Screenscraper.fre\" account"
...
Menu_Config_MediaType()
{
    ...
    "Retroarch scraped media type? (currently: $RetroarchMediaType))" -b "Press A to validate your choice.")
    ...
    "Screenscraper scraped media type ? (currently) $ScreenscraperMediaType)" -b "Press A to validate your choice.")
    ...
    [ "$Mychoice" = "$Option9" ]  && MediaType="box-3D" 
    clear
    ...
    Mychoice=$( echo -e "$Option1\n$Option2\n$Option3\n$Option4\n$Option5" | /mnt/SDCARD/.tmp_update/script/shellect.sh -t \
    "Launchbox scraped type ? (currently: $RetroarchMediaType)" -b "Press A to validate your choice.")
