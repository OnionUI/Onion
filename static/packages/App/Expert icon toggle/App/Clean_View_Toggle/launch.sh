...
if [ -f /mnt/SDCARD/App/Clean_View_Toggle/data/.expertON ] ; then
	...
	cp /mnt/SDCARD/App/Clean_View_Toggle/data/MainUI_Clean /mnt/SDCARD/miyoo/app/MainUI
else
	# Expert mode ON
	...
	rm /mnt/SDCARD/miyoo/app/MainUI
	cp /mnt/SDCARD/App/Clean_View_Toggle/data/MainUI_Expert /mnt/SDCARD/miyoo/app/MainUI
fi
