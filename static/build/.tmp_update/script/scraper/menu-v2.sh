...
Menu_Config()
{
    ...
    Option3="Select your returned media types"
    Option3="Toggle scraping in background"
    Option4="Back to Main Menu"
    
    Mychoice=$( echo -e "$Option1\n$Option2\n$Option3\n$Option4\n$Option5" | /mnt/SDCARD/.tmp_update/script/shellect.sh -t \
    "      --== CONFIGURATION MENU ==--" -b "Press A to validate your choice.")
...
Menu_Config_MediaType()
{
    ...
    echo -e "-------------------------------------------------"
    echo -e "Rectroarch:    $RetroarchMediaType\n"
    ...
    Mychoice=$( echo -e "$Option1\n$Option2\n$Option3" | /mnt/SDCARD/.tmp_update/script/shellect.sh -t \
    ...
    Option4="Wheel"
    Option5="Marquee"
    Option6="Screenscraper Mix V1"
    Option7="Screenscraper Mix V2"
    Option8="Box Art 3D"

    Mychoice=$( echo -e "$Option1\n$Option2\n$Option3\n'$Option4\n$Option5\n$Option6\n$Option7\n$Option8" | /mnt/SDCARD/.tmp_update/script/shellect.sh -t\
    "Screenscraper scraping media type ? (currently: $ScreenscraperMediaType)" -b "Press A to validate your choice.")
    
    [ "$Mychoice" = "$Option1" ]  && ScreenscraperMediaType="box-2d"
    [ "$Mychoice" = "$Option2" ]  && ScreenscraperMediaType="sstitle"
    [ "$Mychoice" = "$Option3" ]  && ScreenscraperMediaType="ss"        
    [ "$Mychoice" = "$Option4" ]  && ScreenscraperMediaType="wheel"
    [ "$Mychoice" = "$Option5" ]  && ScreenscraperMediaType="screenmarqueesmall"
    [ "$Mychoice" = "$Option6" ]  && ScreenscraperMediaType="mixrbv1" 
    [ "$Mychoice" = "$Option7" ]  && ScreenscraperMediaType="mixrbv2" 
    [ "$Mychoice" = "$Option8" ]  && ScreenscraperMediaType="box-3D" 
    clear
    ...
    [ "$Mychoice" = "$Option1" ]  && RetroarchMediaType="box2dfront"
    [ "$Mychoice" = "$Option2" ]  && RetroarchMediaType="wheel"
    [ "$Mychoice" = "$Option3" ]  && RetroarchMediaType="screen"
