...
host_save_backup() {
	...
	save_tgbdual="/mnt/SDCARD/Saves/CurrentProfile/saves/gpSP/$host_rom_filename_NoExt.srm"
...
client_save_rename() {
	...
	if [ ! -z "$client_save_file" ]; then
		...
		save_new_path="/mnt/SDCARD/Saves/CurrentProfile/saves/gpSP/$save_new_name"
...
start_retroarch() {
	...
	HOME=/mnt/SDCARD/RetroArch ./retroarch --appendconfig=./.retroarch/easynetplay_override.cfg -H -v -L .retroarch/cores/gpsp_libretro.so "$host_rom" "$client_rom_clone"
